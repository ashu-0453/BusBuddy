...
<body>
    ...
    <div class="container" style="margin: 10px; padding-top: 30px; padding-bottom: 30px;border: 2px solid black; height: auto;">
        <form:form action="/feedback/feedBacksearchformodification" method="get" modelAttribute="feedBack"> 
            <div class="form-group">
                <label for="feedBackId">Feedback ID</label>
                <form:input path="feedBackId" class="form-control" id="feedBackId"/>
            </div>

            <div class="form-group">
                <button type="submit" class="btn btn-primary">Search FeedBack</button>
            </div>
