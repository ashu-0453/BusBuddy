...
<body>
    ...
    <div class="container" style="margin: 10px; padding-top: 30px; padding-bottom: 30px;border: 2px solid black; height: auto;">
        <form:form action="/feedback/addfeedbackprocess" method="post" modelAttribute="feedBack">
        
            <div class="form-group">
                <label for="driverRating">Driver Rating</label>
                <form:input path="driverRating" class="form-control" id="driverRating"/>
            </div>

            <div class="form-group">
                <label for="serviceRating">Service Rating</label>
                <form:input path="serviceRating" class="form-control" id="serviceRating"/>
            </div>
            
            <div class="form-group">
                <label for="overallRating">Overall Rating</label>
                <form:input path="overallRating" class="form-control" id="overallRating"/>
            </div>
            ...
            <div class="form-group">
                ...
                <form:input type="date" path="feedBackdate" class="form-control" id="feedBackdate"/>
            </div>
