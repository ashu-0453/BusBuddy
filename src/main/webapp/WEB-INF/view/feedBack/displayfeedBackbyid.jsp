...
pageEncoding="ISO-8859-1" import="java.util.*,org.hit.reservation.model.*" %>
...
<body>
    ...
    <div class="container" style="margin: 10px; padding-top: 30px; padding-bottom: 30px;border: 2px solid black; height: auto;">
        <form:form action="/feedback/listallfeedbacks" method="get" modelAttribute="feedBack">


        <div class="form-group">
            <label for="driverRating">Driver Rating</label>
            <input type="text" disabled value="${feedBack.driverRating}" class="form-control" id="driverRating"/>
        </div>

        <div class="form-group">
            <label for="serviceRating">Service Rating</label>
            <input type="text" disabled value="${feedBack.serviceRating}" class="form-control" id="serviceRating"/>
        </div>
        
        <div class="form-group">
            <label for="overallRating">Overall Rating</label>
            <input type="text" disabled value="${feedBack.overallRating}" class="form-control" id="overallRating"/>
        </div>

        <div class="form-group">
            <label for="comments">Comments</label>
            <input type="text" disabled value="${feedBack.comments}" class="form-control" id="comments"/>
        </div>

        <div class="form-group">
            <label for="feedBackdate">FeedBack Date</label>
            <input type="date" disabled value="${feedBack.feedBackdate}" class="form-control" id="feedBackdate"/>
        </div>
        
            
            <div class="form-group">
                <button type="submit" class="btn btn-primary">View All FeedBacks</button>
            </div>
