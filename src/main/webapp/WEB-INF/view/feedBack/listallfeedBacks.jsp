...
pageEncoding="ISO-8859-1" import="java.util.*, org.hit.model.*" %>
...
<body>
    ...
    <!-- <div class="container" style="margin: 10px; padding-top: 30px; padding-bottom: 30px;border: 2px solid black; height: auto;"> -->
        ...
        <tbody>
            ...
            <%
            List<FeedBack> list= (List<FeedBack>) request.getAttribute("feedBacks");
            for(FeedBack feedBack:list)
            {
                out.println("<tr>");
                    out.println("<td scope=\"row\">" +feedBack.getFeedBackId()+ "</td>");
                    out.println("<td>" +feedBack.getDriverRating()+ "</td>");
                    out.println("<td>" +feedBack.getServiceRating()+ "</td>");
                    out.println("<td>" +feedBack.getOverallRating()+ "</td>");
                    out.println("<td>" +feedBack.getComments()+ "</td>");
                    out.println("<td>" +feedBack.getFeedBackdate()+ "</td>");

                    out.println("<td><a href=\"http://localhost:5000/feedback/feedbacksearchbyid?feedBackId=" + feedBack.getFeedBackId() + "\"><button>View</button></a></td>");
                    out.println("<td><a href=\"http://localhost:5000/feedback/delfeedbackfromall?feedBackId=" + feedBack.getFeedBackId() + "\"><button>Delete</button></a></td>");
