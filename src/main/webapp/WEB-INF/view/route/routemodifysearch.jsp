...
<body>
    ...
    <div class="container" style="margin: 10px; padding-top: 30px; padding-bottom: 30px;border: 2px solid black; height: auto;">
        <form:form action="/route/modifyrouteprocess" method="post" modelAttribute="route">
        ...
        <form:hidden path = "routeId" value = "${route.routeId}" />
            ...
            <div class="form-group">
                ...
                <form:input path="routeFrom" value="${route.routeFrom}" class="form-control" id="routeFrom"/>
            </div>

            <div class="form-group">
                <label for="routeTo">Destination</label>
                <form:input path="routeTo" value="${route.routeTo}" class="form-control" id="routeTo"/>
            </div>
            

            <div class="form-group">
                <label for="distance">Distance (in Kms) </label>
                <form:input path="distance" value="${route.distance}" class="form-control" id="distance"/>
            </div>
