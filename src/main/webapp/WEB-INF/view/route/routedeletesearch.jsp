...
<body>
    ...
    <div class="container" style="margin: 10px; padding-top: 30px; padding-bottom: 30px;border: 2px solid black; height: auto;">
        <form:form action="/route/deleterouteprocess" method="post" modelAttribute="route">
        
        <form:hidden path = "routeId" value = "${route.routeId}" />
            ...
            <div class="form-group">
                ...
                <input type="text" disabled value="${route.distance}" class="form-control" id="distance"/>
            </div>
