...
<body>
    ...
    <div class="container" style="margin: 10px; padding-top: 30px; padding-bottom: 30px;border: 2px solid black; height: auto;">
        <form:form action="/route/listallroutes" method="get" modelAttribute="route">
        
            <div class="form-group">
                <label for="routeFrom">Source</label>
                <input type="text" disabled value= "${route.routeFrom}" class="form-control" id="routeFrom"/>
            </div>

            <div class="form-group">
                <label for="routeTo">Destination</label><br>
                <input type="text" disabled value= "${route.routeTo}" class="form-control" id="routeTo"/>
            </div>

            <div class="form-group">
                <label for="routeDistance">Distance</label>
                <input type="text" disabled value="${route.distance}" class="form-control" id="routeDistance"/>
            </div>


            <div class="form-group">
                <button type="submit" class="btn btn-primary">View All Routes</button>
            </div>
