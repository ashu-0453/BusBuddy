...
<body>
    ...
    <div class="container" style="margin: 10px; padding-top: 30px; padding-bottom: 30px;border: 2px solid black; height: auto;">
        <form:form action="/route/routesearchformodification" method="get" modelAttribute="route"> 
            <div class="form-group">
                <label for="routeId">Route ID</label>
                <form:input path="routeId" class="form-control" id="routeId"/>
            </div>

            <div class="form-group">
                <button type="submit" class="btn btn-primary">Search Route</button>
            </div>
