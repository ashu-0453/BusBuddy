...
<body>
    ...
    <!-- <div class="container" style="margin: 10px; padding-top: 30px; padding-bottom: 30px;border: 2px solid black; height: auto;"> -->
        ...
        <tbody>
            ...
            {
                out.println("<tr>");
                    out.println("<td scope=\"row\">" +route.getRouteId()+ "</td>");
                    out.println("<td>" +route.getRouteFrom()+ "</td>");
                    out.println("<td>" +route.getRouteTo()+ "</td>");
                    out.println("<td>" +route.getDistance()+ "</td>");

                    out.println("<td><a href=\"http://localhost:5000/route/displayroutebyid?routeId=" + route.getRouteId() + "\"><button>View</button></a></td>");
                    out.println("<td><a href=\"http://localhost:5000/route/delroutefromall?routeId=" + route.getRouteId() + "\"><button>Delete</button></a></td>");
