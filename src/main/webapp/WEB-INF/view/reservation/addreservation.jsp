...
<body>
    ...
    <div class="container" style="margin: 10px; padding-top: 30px; padding-bottom: 30px;border: 2px solid black; height: auto;">
        <form:form action="/reservation/addreservationprocess" method="post" modelAttribute="reservation">
        
            <div class="form-group">
                <label for="reservationStatus">Reservation Status</label>
                <form:input path="reservationStatus" class="form-control" id="reservationStatus"/>
            </div>
            ...
            <div class="form-group">
                ...
                <form:input type="date" path="reservationDate" class="form-control" id="reservationDate"/>
            </div>

            <div class="form-group">
                <label for="reservationTime">Bus Time</label>
                <form:input type="time" path="reservationTime" class="form-control" id="reservationTime"/>
            </div>
