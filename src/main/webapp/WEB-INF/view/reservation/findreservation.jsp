...
<body>
    ...
    <div class="container" style="margin: 10px; padding-top: 30px; padding-bottom: 30px;border: 2px solid black; height: auto;">
        <form:form action="/reservation/listbydate" method="get" modelAttribute="reservation"> 
            <div class="form-group">
                <label for="reservationDate">Reservation Date</label>
                <form:input path="reservationDate" type="date" class="form-control" id="reservationDate"/>
            </div>
