...
<body>
    ...
    <div class="container" style="margin: 10px; padding-top: 30px; padding-bottom: 30px;border: 2px solid black; height: auto;">
        <form:form action="/reservation/listallusers" method="get" modelAttribute="reservation">
        
            <div class="form-group">
                <label for="reservationStatus">Reservation Status</label>
                <input type="text" disabled value= "${reservation.reservationStatus}" class="form-control" id="reservationStatus"/>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" disabled value="${reservation.reservationDate}" class="form-control" id="reservationDate"/>
            </div>

            <div class="form-group">
                <label for="reservationTime">Reservation Time</label>
                <input type="text" disabled value="${reservation.reservationTime}" class="form-control" id="reservationTime"/>
            </div>

            <div class="form-group">
                <label for="source">Source</label>
                <input type="text" disabled value="${reservation.source}" class="form-control" id="source"/>
            </div>

            <div class="form-group">
                <label for="destination">Destination</label>
                <input type="text" disabled value="${reservation.destination}" class="form-control" id="destination"/>
            </div>
