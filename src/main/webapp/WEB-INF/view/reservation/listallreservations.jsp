...
<body>
    ...
    <!-- <div class="container" style="margin: 10px; padding-top: 30px; padding-bottom: 30px;border: 2px solid black; height: auto;"> -->
        ...
        <tbody>
            ...
            {
                out.println("<tr>");
                    out.println("<td scope=\"row\">" + reservation.getReservationId() + "</td>");
                    out.println("<td>"+reservation.getReservationStatus()+" </td>");
                    out.println("<td>"+reservation.getReservationType()+" </td>");
                    out.println("<td>"+reservation.getReservationDate()+" </td>");
                    out.println("<td>"+reservation.getReservationTime()+" </td>");
                    out.println("<td>"+reservation.getSource()+" </td>");
                    out.println("<td>"+reservation.getDestination()+" </td>");

                    out.println("<td><a href=\"http://localhost:5000/reservation/displayreservationbyid?reservationId=" + reservation.getReservationId() + "\"><button>View</button></a></td>");
                    out.println("<td><a href=\"http://localhost:5000/reservation/delreservationfromall?reservationId=" + reservation.getReservationId() + "\"><button>Delete</button></a></td>");
