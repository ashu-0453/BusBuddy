        ...
        <tbody>
            ...
            for(Bus bus:list)
            {
                out.println("<tr>");
                    ...
                    out.println("<td>" +bus.getBusType()+ "</td>");
                    out.println("<td>" +bus.getRouteFrom()+ "</td>");

                    out.println("<td>" +bus.getRouteTo()+ "</td>");
                    out.println("<td>" +bus.getBusDate()+ "</td>");

                    out.println("<td>" +bus.getArrivalTime()+ "</td>");
                    out.println("<td>" +bus.getDepartureTime()+ "</td>");
                    out.println("<td>" +bus.getSeats()+ "</td>");
                    out.println("<td>" +bus.getAvailableSeats()+ "</td>");

                    out.println("<td><a href=\"http://localhost:5000/bus/displaybusbyid?busId=" + bus.getBusId() + "\"><button>View</button></a></td>");
                    out.println("<td><a href=\"http://localhost:5000/bus/delbusfromall?busId=" + bus.getBusId() + "\"><button>Delete</button></a></td>");
