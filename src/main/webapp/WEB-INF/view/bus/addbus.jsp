...
<body>
    ...
    <div class="container" style="margin: 10px; padding-top: 30px; padding-bottom: 30px;border: 2px solid black; height: auto;">
        <form:form action="/bus/addbusprocess" method="post" modelAttribute="bus">
        
            <div class="form-group">
                <label for="busName">Bus Name</label>
                <form:input path="busName" class="form-control" id="busName"/>
            </div>

            <div class="form-group">
                <label for="driverName">Driver Name</label>
                <form:input path="driverName" class="form-control" id="driverName"/>
            </div>
            ...
            <div class="form-group">
                ...
                <form:input path="routeFrom" class="form-control" id="routeFrom"/>
            </div>

            <div class="form-group">
                <label for="routeTo">Destination</label>
                <form:input path="routeTo" class="form-control" id="routeTo"/>
            </div>

            <div class="form-group">
                <label for="busDate">Bus Date</label>
                <form:input type="date" path="busDate" class="form-control" id="busDate"/>
            </div>
            ...
            <div class="form-group">
                ...
                <form:input type="time" path="arrivalTime" class="form-control" id="arrivalTime"/>
            </div>

            <div class="form-group">
                <label for="departureTime">Departure Time</label>
                <form:input type="time" path="departureTime" class="form-control" id="departureTime"/>
            </div>

            <div class="form-group">
                <label for="seats">Total Seats</label>
                <form:input path="seats" class="form-control" id="seats"/>
            </div>

            <div class="form-group">
                <label for="availableSeats">Available Seats</label>
                <form:input path="availableSeats" class="form-control" id="availableSeats"/>
            </div>
