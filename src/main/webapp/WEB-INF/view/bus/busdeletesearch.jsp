                    ...
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu border-0 rounded-0 m-0">
                                ...
                                <a href="#" class="dropdown-item">Bus Service</a>
        ...
        <div class="row pt-5">
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <div class="d-flex flex-column justify-content-start">
                    ...
                    <a class="text-white-50" href="route/displayroutebyidindividual"><i class="fa fa-angle-right mr-2"></i>Display Route</a>
                    <a class="text-white-50" href="feedback/addfeedback"><i class="fa fa-angle-right mr-2"></i>Add Feedback</a>
                    <a class="text-white-50" href="user/adduser"><i class="fa fa-angle-right mr-2"></i>Add User</a>
