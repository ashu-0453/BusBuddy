...
<body>
            ...
            <nav class="navbar navbar-expand-lg bg-light navbar-light shadow-lg py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        <a href="../../loginAsAdmin.html" class="nav-item nav-link active">Home</a>
                        <a href="../about.html" class="nav-item nav-link">About</a>
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Pages</a>
                            <div class="dropdown-menu border-0 rounded-0 m-0">

                                <a href="../../../loginasadmin/User.html" class="dropdown-item">User</a>
                                <a href="../../../loginasadmin/Reservation.html" class="dropdown-item">Reservation</a>
                                <a href="../../../loginasadmin/Bus.html" class="dropdown-item">Bus Service</a>
                                <a href="../../../loginasadmin/Route.html" class="dropdown-item">Route</a>
                                <a href="../../../loginasadmin/FeedBack.html" class="dropdown-item">Feedback</a>
                            </div>
                        </div>
    ...
    <div class="container" style="margin: 10px; padding-top: 30px; padding-bottom: 30px;border: 2px solid black; height: auto;">
        <form:form action="/bus/deletebusprocess" method="post" modelAttribute="bus">

        <form:hidden path = "busId" value = "${bus.busId}" />
        
            <div class="form-group">
                <label for="busName">Bus Name</label>
                <input type="text" disabled value="${bus.busName}" class="form-control" id="busName"/>
            </div>

            <div class="form-group">
                <label for="driverName">Driver Name</label>
                <input type="text" disabled value="${bus.driverName}" class="form-control" id="driverName"/>
            </div>
            ...
            <div class="form-group">
                ...
                <div style="padding-left: 20px;">
                    General : <form:radiobutton path="busType" value="General"/><br>
                    AC : <form:radiobutton path="busType" value="AC"/>
                </div>
            </div>

            <div class="form-group">
                <label for="routeFrom">Source</label>
                <input type="text" disabled value="${bus.routeFrom}" class="form-control" id="routeFrom"/>
            </div>

            <div class="form-group">
                <label for="routeTo"> Destination </label>
                <input type="text" disabled value="${bus.routeTo}" class="form-control" id="routeTo"/>
            </div>

            <div class="form-group">
                <label for="arrivalTime">Arrival Time</label>
                <input type="time" disabled value="${bus.arrivalTime}" class="form-control" id="arrivalTime"/>
            </div>

            <div class="form-group">
                <label for="departureTime">Departure Time</label>
                <input type="time" disabled value="${bus.departureTime}" class="form-control" id="departureTime"/>
            </div>

            <div class="form-group">
                <label for="seats">Total Seats</label>
                <input type="text" disabled value="${bus.seats}" class="form-control" id="seats"/>
            </div>

            <div class="form-group">
                <label for="availableSeats">Available Seats</label>
                <input type="text" disabled value="${bus.availableSeats}" class="form-control" id="availableSeats"/>
            </div>

            <div class="form-group">
                <button type="submit" class="btn btn-primary">Delete Bus</button>
            </div>
