...
pageEncoding="ISO-8859-1" import="java.util.*,org.hit.user.model.*" %>
...
<body>
    ...
    <div class="container" style="margin: 10px; padding-top: 30px; padding-bottom: 30px;border: 2px solid black; height: auto;">
        <form:form action="/user/listallusers" method="get" modelAttribute="user">
            ...
            <div class="form-group">
                ...
                <input type="text" disabled value="${user.password}" class="form-control" id="pass"/>
            </div>
