...
<body>
    ...
    <div class="container" style="margin: 10px; padding-top: 30px; padding-bottom: 30px;border: 2px solid black; height: auto;">
        <form:form action="/user/modifyuserprocess" method="post" modelAttribute="user">
        
        <form:hidden path = "userLoginid" value = "${user.userLoginid}" />

            <div class="form-group">
                <label for="username">UserName</label>
                <form:input path="username" value="${user.username}" class="form-control" id="username"/>
            </div>

            <div class="form-group">
                <label for="pass">password</label>
                <form:input path="password" value="${user.password}" class="form-control" id="pass"/>
            </div>

            <div class="form-group">
                <label for="firstname">First Name</label>
                <form:input path="firstName" value="${user.firstName}" class="form-control" id="firstname"/>
            </div>

            <div class="form-group">
                <label for="lastname">Last Name</label>
                <form:input path="lastName" value="${user.lastName}" class="form-control" id="lastname"/>
            </div>

            <div class="form-group">
                <label for="Contact">Contact</label>
                <form:input path="contact" value="${user.contact}" class="form-control" id="Contact"/>
            </div>

            <div class="form-group">
                <label for="email">E-mail</label>
                <form:input path="email" value="${user.email}" class="form-control" id="email"/>
            </div>
