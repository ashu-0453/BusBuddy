...
<body>
    ...
    <div class="container" style="margin: 10px; padding-top: 30px; padding-bottom: 30px;border: 2px solid black; height: auto;">
        <form:form action="/user/deleteuserprocess" method="post" modelAttribute="user">

        <form:hidden path = "userLoginid" value = "${user.userLoginid}"/>

            <div class="form-group">
                <label for="username">UserName</label>
                <input type="text" disabled value="${user.username}" class="form-control" id="username"/>
            </div>

            <div class="form-group">
                <label for="password">Password</label>
                <input type="text" disabled value="${user.password}" class="form-control" id="password"/>
            </div>

            <div class="form-group">
                <label for="firstname">First Name</label>
                <input type="text" disabled value="${user.firstName}" class="form-control" id="firstname"/>
            </div>

            <div class="form-group">
                <label for="lastname">Last Name</label>
                <input type="text" disabled value="${user.lastName}" class="form-control" id="lastname"/>
            </div>

            <div class="form-group">
                <label for="Contact">Contact</label>
                <input type="text" disabled value="${user.contact}" class="form-control" id="Contact"/>
            </div>
