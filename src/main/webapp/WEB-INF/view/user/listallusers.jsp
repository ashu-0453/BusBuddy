...
<body>
    ...
    <!-- <div class="container" style="margin: 10px; padding-top: 30px; padding-bottom: 30px;border: 2px solid black; height: auto;"> -->
        ...
        <tbody>
            ...
            {
                out.println("<tr>");
                    out.println("<td scope=\"row\">" + user.getUserLoginid() + "</td>");
                    out.println("<td>"+user.getFirstName()+" </td>");
                    out.println("<td>"+user.getLastName()+" </td>");
                    out.println("<td>"+user.getContact()+" </td>");
                    out.println("<td>"+user.getEmail()+" </td>");
                    out.println("<td><a href=\"http://localhost:5000/user/displayuserbyid?userLoginid=" + user.getUserLoginid() + "\"><button>View</button></a></td>");
                    out.println("<td><a href=\"http://localhost:5000/user/deluserfromall?userLoginid=" + user.getUserLoginid() + "\"><button>Delete</button></a></td>");
